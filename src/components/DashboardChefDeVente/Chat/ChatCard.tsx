...
const chatData: Chat[] = [
  {
    ...
    name: "Chargé de Projet Marketing",
    text: "Nous avons beaucoup de colis ici.",
    time: "12 min",
    textCount: 3,
    dot: 3,
  },
  {
    ...
    name: "Edvige",
    text: "Il faut tout vendre d'ici ce weekend.",
    time: "12h14 min",
    textCount: 0,
    dot: 1,
  },
  ...
  },
  {
    ...
    avatar: "/images/user/user-09.png",
    name: "Martime",
    text: "Nous avons une stratégie et le compte est à 3.500.000xof pour les produits restants",
    time: "Sun",
    textCount: 2,
    dot: 6,
  },
