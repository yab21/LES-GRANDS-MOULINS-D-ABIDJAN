...
const ModifierProfil = () => {
  return (
    <>
      <Breadcrumb pageName="Modifier votre profil" />
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        defaultValue="redmondisai@gma.com"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="contact 1"
                        id="contact 1"
                        placeholder="Entrer votre contact 1"
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="contact 2"
                      id="contact 2"
                      placeholder="Entrer votre contact 2"
                ...
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="flex gap-3">
                      ...
                      <button className="text-body-sm hover:text-orange-400">
                        Mise à jour
                      </button>
                    </span>
                  </div>
