...
import SidebarItem from "@/components/DashboardChefDeVente/SidebarChefDeVente/SidebarItem";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Liste", route: "/dashboardchefdevente/commerciaux/liste" },
          {
            label: "Historique des ventes",
            route: "/dashboardchefdevente/commerciaux/historiquedesventes",
          },
          {
            label: "Performance",
            route: "/dashboardchefdevente/commerciaux/performance",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            route: "/dashboardchefdevente/rendezvous/creer",
          },
          {
            label: "Liste",
            route: "/dashboardchefdevente/rendezvous/liste",
          },
          {
            label: "Map",
            route: "/dashboardchefdevente/rendezvous/map",
          },
        ],
      },
      {
        ...
        route: "#",
        children: [
          { label: "Ajouter", route: "/dashboardchefdevente/client/ajouter" },
          {
            label: "Liste",
            route: "/dashboardchefdevente/client/liste",
          },
        ],
      },
      {
        ...
        route: "#",
        children: [
          { label: "Créer", route: "/dashboardchefdevente/devis/creer" },
          {
            label: "Liste",
            route: "/dashboardchefdevente/devis/liste",
          },
        ],
      },
      {
        ...
        children: [
          {
            label: "journalière",
            route: "/dashboardchefdevente/ventes/journaliere",
          },
          {
            label: "Tableau",
            route: "/dashboardchefdevente/ventes/tableau",
          },
        ],
      },
      {
        ...
        route: "#",
        children: [
          { label: "Ajouter", route: "/dashboardchefdevente/tickets/ajouter" },
          {
            label: "Liste",
            route: "/dashboardchefdevente/tickets/liste",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            route: "/dashboardchefdevente/activites/gestionsdestaches",
          },
          {
            label: "Gestion d'espace de travail",
            route: "/dashboardchefdevente/activites/gestiondespacedetravail",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            route: "/dashboardchefdevente/telephone/appel",
          },
        ],
      },
      {
        ...
        label: "Carte",
        route: "/dashboardchefdevente/carte",
      },
    ],
  },
  {
    ...
    menuItems: [
      {
        ...
        children: [
          {
            label: "Nouveau mail",
            route: "/dashboardchefdevente/mail/nouveaumail",
          },
          {
            label: "Mail envoyé",
            route: "/dashboardchefdevente/mail/mailenvoye",
          },
          {
            label: "Mail reçu",
            route: "/dashboardchefdevente/mail/mailrecu",
          },
          {
            label: "Mail supprimé",
            route: "/dashboardchefdevente/mail/mailsupprime",
          },
        ],
      },
      {
        ...
        children: [
          {
            label: "Voir",
            route: "/dashboardchefdevente/profil/voir",
          },
          {
            label: "Modifier",
            route: "/dashboardchefdevente/profil/modifier",
          },
          {
            label: "Changer mot de passe",
            route: "/dashboardchefdevente/profil/changermotdepasse",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            route: "/dashboardchefdevente/agenda/creerunevenement",
          },
          {
            label: "Liste",
            route: "/dashboardchefdevente/agenda/liste",
          },
        ],
      },
      {
