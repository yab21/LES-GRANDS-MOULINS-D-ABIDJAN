...
const ListeDesDevis = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Liste des devis" />
            ...
            <div className="flex-wrap items-center justify-between md:flex">
              ...
              <div className="-mb-2 w-64 flex-auto">
                <CheckboxGroup
                  ...
                  color="warning"
                  defaultValue={["mes devis", "tous mes devis"]}
                >
                  <Checkbox value="buenos-aires">Mes devis</Checkbox>
                  <Checkbox value="sydney">Tous mes devis</Checkbox>
                </CheckboxGroup>
              </div>
            </div>
          </div>
            ...
            <table className="w-full table-auto text-left text-sm">
              <thead className="border-b bg-gray-1 font-medium text-dark dark:bg-gray-dark dark:text-white">
                <tr>
                  ...
                  <th className="px-3 py-3">Numéro du devis</th>
