        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4 text-dark dark:text-white">
            ...
            <div className="flex justify-center">
              <Image src="/images/icon/dot.svg" width={35} height={35} alt="" />
            </div>
            <div className="mt-2 flex justify-center gap-4">
              <p className="text-lg font-thin">
                Identifiant: <span className="font-medium">Serges</span>
              </p>
              <p className="text-lg font-thin">
                Adresse: <span className="font-medium">Abidjan</span>
              </p>
            </div>
            <div className="mx-auto mt-6 max-w-[720px]">
              <div className="grid w-full grid-cols-2 gap-4">
                <Input
                  ...
                  size="lg"
                  defaultValue="10:35"
                  className="text-base font-thin dark:text-white md:text-xl"
                  labelPlacement="outside"
                />
                <Input
                  isReadOnly
                  type="Date de connexion"
