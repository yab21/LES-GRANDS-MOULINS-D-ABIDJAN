...
import SearchForm from "@/components/DashboardCommercial/HeaderCommercial/SearchForm";
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        ...
        <div className="hidden xl:block">
          <div>
            ...
            <p className="font-medium">Tableau de bord du compte Commercial</p>
          </div>
        </div>
